    ...
    <div className="min-h-screen bg-white dark:bg-[#0F172A] text-slate-800 dark:text-slate-200 transition-colors duration-300 py-20 px-6">
      <div className="max-w-2xl mx-auto space-y-10">
        ...
        <header className="space-y-2 border-b border-slate-100 dark:border-slate-800 pb-8">
          ...
          <p className="text-sm text-slate-400 dark:text-slate-500 font-medium">시행일자: {lastUpdated}</p>
        </header>

        <section className="space-y-4">
          <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 tracking-tight border-l-4 border-[#E91E63] pl-4">
            1. 목적
          </h2>
        ...
        <footer className="pt-10 border-t border-slate-100 dark:border-slate-800 text-[11px] text-slate-400 dark:text-slate-600">
